   ...
   <div class="row">
      <div class="col-lg-6">
         ...
         <div class="card shadow mb-4">
            ...
            <div class="card-body">
               <form action="<?php echo site_url(); ?>guru_siswa/edit_siswa_guru/<?php echo $alt['id_siswa']; ?>" <?php echo $alt['id_siswa']; ?> method="post">
                  ...
                  <div class="d-flex mt-4">
                     <a href="<?php echo site_url(); ?>guru_siswa" class="btn btn-secondary ml-auto">Kembali</a>
