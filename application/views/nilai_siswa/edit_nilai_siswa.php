   ...
   <div class="row">
      <div class="col-lg-6">
         ...
         <div class="card shadow mb-4">
            ...
            <div class="card-body">
               <form action="<?php echo site_url(); ?>nilai_siswa/edit_nilai_siswa/<?php echo $nisis['id_siswa']; ?>" <?php echo $nisis['id_siswa']; ?> method="post">
                  <div class="form-group row">
                     <label for="nama_siswa" class="col-lg-3 col-form-label">Nama Siswa *</label>
                     <div class="col-lg-9">
                        <input type="text" class="form-control" id="nama_siswa" name="nama_siswa" value="<?php echo $data['nama_siswa']; ?>" autofocus>
                  ...
                  <div class="form-group row">
                     ...
                     <div class="col-lg-9">
                        <input type="number" class="form-control" id="akademik" name="akademik" value="<?php echo $nisis['akademik']; ?>"></input>
                  ...
                  <div class="form-group row">
                     ...
                     <div class="col-lg-9">
                        <input type="number" class="form-control" id="sikap" name="sikap" value="<?php echo $nisis['sikap']; ?>"></input>
                  ...
                  <div class="form-group row">
                     ...
                     <div class="col-lg-9">
                        <input type="number" class="form-control" id="keaktifan" name="keaktifan" value="<?php echo $nisis['keaktifan']; ?>"></input>
