...
<div class="container-fluid">
   ...
   <div class="d-sm-flex align-items-center mb-4">
      <h1 class="h3 mb-0 text-gray-800 mr-4">Hasil</h1>
   </div>
   ...
   <?php if ($bobot_kriteria) : ?>
      <div class="card">
         <div class="card-header">Bobot Prioritas</div>
         <div class="card-body">
               ...
               <thead class="thead-dark">
                  <tr>
                     ...
                     <?php for ($i = 0; $i < count($kriteria); $i++) : ?>
                        <th scope="col"><?php echo $kriteria[$i]['nama_kriteria']; ?></th>
                     <?php endfor; ?>
                  </tr>
               </thead>
               <tbody>
                  ...
                  <tr>
                     ...
                     <?php for ($i = 0; $i < count($kriteria); $i++) : ?>
                        <th scope="col"><?php echo $bobot_kriteria[$i]; ?></th>
                     <?php endfor; ?>
                  </tr>
               </tbody>
            </table>
