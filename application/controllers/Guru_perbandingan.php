...
class Guru_perbandingan extends CI_Controller
{
   ...
   public function perbandingan_kriteria()
   {
      if (!$this->session->userdata('loggedIn')) {
         ...
         if ($nilai_kriteria) {
            ...
            $this->load->view('guru_perhitungan/guru_perbandingan/perbandingan_kriteria/index');
   ...
   public function perbandingan_alternatif()
   {
      if (!$this->session->userdata('loggedIn')) {
         ...
         $this->load->view('templates/guru_sidebar');
         $this->load->view('templates/admin_topbar');
         $this->load->view('guru_perhitungan/guru_perbandingan/perbandingan_alternatif/index');
         $this->load->view('templates/admin_footer');
      }
   }
   ...
   {
      $this->Kriteria->truncate_nilai();
      redirect('guru_perbandingan/perbandingan_kriteria');
   }
